...
/**
 * company_dashboard is the same as company_detail but assumes that the user
 * accessing the page is a registered user under the company role
 */
...
$company = Company::find($authUser->id);
