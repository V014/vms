...
<li class="nav-item"><a class="nav-link <?php echo preg_match("/drivers/", $currentPage) == 1 ? "active" : "" ?>" href="drivers.php"><i class="fas fa-steering-wheel"></i><span>Drivers</span></a></li>
